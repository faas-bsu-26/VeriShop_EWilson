        ...
        <div className="about-header">
          ...
          <div className="about-content">
            <p>
              ...
              products from anyone on the internet, we only feature products
              from verified website owners who have gone through an interview
              process and background checks before being accepted onto the
              platform.
            </p>

            <p>
              Our goal is to bring together reliable online stores in one place,
              making it easier for shoppers to discover products from sources
              they can trust. Each product listing clearly shows the website it
              comes from so users always know exactly where the item originates.
            </p>
